...
3. **The engine also runs four unrelated domains** — DevOps, FinOps, Legal, Civic
   ...
   > submission deploys **23 tools across three services — 8 on MCP-1, 6 on MCP-2, 9 on
   > MCP-3 — and all 23 are MENTOR's loop**. The other four adapters ship unregistered,
